...
def create_message(sender, to, subject, message_text, attachments=None):
    ...
    # Detect if the message is HTML
    is_html = '<html' in message_text.lower() or '<p>' in message_text.lower() or '<br' in message_text.lower()
    ...
    if not st.session_state.authenticated:
        ...
        with tabs[1]:
            ...
            if 'df' not in st.session_state:
                ...
                # Simple implementation without rich text editor
                ...
                # Allow HTML option
                use_html = st.checkbox("Send as HTML", value=False)
                if use_html:
                    st.info("When using HTML, add <p> tags for paragraphs and <br> for line breaks")
